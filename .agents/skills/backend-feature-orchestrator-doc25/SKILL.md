...
1. **Understanding & Discovery**: Analise o pedido do PO, verifique as regras de negócio em `rules/`, e busque patterns e outras skills existentes em `.agents/skills` para evitar retrabalho.
